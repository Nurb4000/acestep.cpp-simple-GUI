...
MODEL_INFERENCE_STEPS = {
    "./models/acestep-v15-xl-turbo-Q8_0.gguf": 8,
...
def get_default_values():  
    return {  
        ...
        "dit_model": "./models/acestep-v15-xl-turbo-Q8_0.gguf"  # Default model
    }  
...
def generate():  
    ...
    try:  
        ...
        dit_model = request.form.get('dit_model', './models/acestep-v15-xl-turbo-Q8_0.gguf')
        # Validate model path
        if dit_model not in MODEL_INFERENCE_STEPS:
            dit_model = './models/acestep-v15-xl-turbo-Q8_0.gguf'
